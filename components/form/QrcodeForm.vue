<template>
  <div>
    ...
    <div class="flex flex-col items-center gap-6 md:flex-row md:items-start md:gap-1">
      <div class="w-full md:max-w-[70%]">
        <Form ref="form" v-slot="{ errors }" :validation-schema="$commonSchema" @submit="onSubmit">
          <div
      ...
      <div class="w-full md:max-w-[30%]">
        <div>
          <a class="inline-block w-full text-center" :href="link" target="_blank">
            <slot name="forminfo"></slot>
            <img class="mx-auto inline-block w-full max-w-[400px]" :src="qrurl" alt="qrcode" />
          </a>
        </div>
      </div>
    </div>
